...
/////////  NEDERLANDS //////////////////////////////
    nl: [
        ...
        write_paragraph_body("img_envelope_0_0",
            [ "<p>De berichtenservice is een nieuw onderdeel van AWP, waarmee je berichten kunt versturen naar andere gebruikers van AWP-online. ",
                ...
                "Wanneer je een bericht hebt verzonden stuurt AWP het bericht ook per e-mail naar alle geadresseerden. De bijlagen worden niet meegestuurd met de e-mail.</p>",
            ]),

        write_paragraph_body("img_exclamationsign",
            ["<p>De berichtenservice is alleen voor mededelingen van algemene aard. ",
                "Voor de communicatie met de Inspectie en het ETE over individuele kandidaten is er een kolom <i>Opmerkingen</i> in de pagina's 'Cijfers', 'Vakken' en 'Kandidaten'.</p>"]),
        ...
        write_paragraph_body("img_envelope_0_2",
            ...
            "Klik hierop om de berichtenpagina te openen. ",
            "Klik vervolgens op de tab <i>Ontvangen berichten</i> en klik op het bericht om het te openen.<br>",
        ...
        write_paragraph_body("",
            ["<p>Klik in de menubalk op <i>Nieuw bericht aanmaken</i>. Het onderstaande venster verschijnt.</p>",
                ...
                "Alleen de gebruikers van wie de account geactiveerd en niet niet-actief is, ontvangen het bericht.<br>",
                "AWP stuurt het bericht ook per e-mail naar alle geadresseerde gebruikers. ",
                "De bijlagen worden niet meegestuurd met de e-mail maar kunnen worden gedownload vanuit de berichtenpagina.<br>",
        ...
        write_paragraph_body("",
            ["<p class='pb-0'>Je kun op drie verschillende manieren de geadresseerden voor een bericht selecteren:</p>",
                ...
                "AWP stuurt het bericht ook per e-mail naar elke organisatie, zonder bijlagen. Alle geselecteerde gebruikers van deze organisatie ontvangen die e-mail.</p>",
...
/////////  ENGLISH //////////////////////////////
    en:  [
write_paragraph_header("id_intro_mailbox", "Message service"),
        write_paragraph_body("img_envelope_0_0",
            [ "<p>The messaging service is a new part of AWP, which allows you to send messages to other users of AWP-online. ",
                "These may be messages to the Division of Examinations, to the Inspectorate or to other users of your school or other schools. ",
                "The Division of Examinations will now use this messaging service to send information about the exams.</p>",
                "<p>The messages can be found in the <i>Received messages</i> tab on the message page. Click on the envelope in the upper right corner of the title bar to go to this page. ",
                "When you have sent a message, AWP also sends the message to all recipients by email. The attachments are not sent with the email.</p>",
            ]),

        write_paragraph_body("img_exclamationsign",
            ["<p>The messaging service is for communications of a general nature only. ",
                "For communication with the Inspectorate and the Division of Examinations about individual candidates, there is a column <i>Comments</i> in the pages 'Grades', 'Subjects' and 'Candidates'.</p>"
            ]),
        ...
        write_paragraph_body("img_envelope_0_2",
            ...
            "Click to open the message page. ",
            "Then click on the <i>Received Messages</i> tab and click on the message to open it.<br>",
            "When you open a new message it will be marked as 'read'. The icon with the white envelope and the red flag disappears. ",
            "You can also manually mark a message as 'read'. Then click on the icon with the white envelope. ",
            ...
            "If you want to save the attachment, you can click the right mouse button in the attachment window. In the window that appears, click on <i>Save as...</i>.</p>",

            "<p><b>Show recipients</b><br>",
            "Click in the box with <i>Recipients</i>. The list of recipients of this message will now be displayed. Click again and the list will close.</p>"
            ]),

        write_paragraph_body("img_delete_0_2",
             ["<p><b>Delete a message</b><br>",
             "Click the cross icon on the right of a message line to delete it.</p>",

             "<p><b>Undelete</b><br>",
             "You can retrieve a deleted message as follows:<br>",
             "Click on the right in the filter line (that is the second gray line of the table) on the icon with the cross. ",
             "All deleted messages are now displayed. They have a red cross icon.<br>",
             "Click the cross icon to undo the deletion.</p>"
            ]),
        ...
        write_paragraph_body("",
            ["<p>Click <i>Create new message</i> in the menu bar. The window below will appear.</p>",
                ...
                "<p><b>Post title</b><br>",
                "In the top line of the right frame, enter the title of the message. The title must be entered and can contain a maximum of 80 characters. ",
                ...
                "Select the file you want to attach as an attachment and click <i>Open</i> .",
                ...
                "Click <i>Send</i>. AWP will now send the message to all addressed users. ",
                "Only the users whose account is activated and not inactive will receive the message.<br>",
                "AWP also sends the message by email to all addressed users. ",
                "The attachments are not sent with the email but can be downloaded from the message page.<br>",
                "After sending the emails, a log file with the names of the recipients will be downloaded.</p>"
            ]),
        ...
        write_paragraph_body("",
            ["<p class='pb-0'>You can select the recipients for a message in three different ways:</p>",
                ...
                "AWP also sends the message by email to all selected organizations, without attachments. All selected users of this organization will receive that email.</p>",
                ...
                "Organisations mean the schools, but the Division of Examinations and the Inspectorate are also an organisation.<br>",
                "Click on <i>Send to organisations...</i>. The <i>Select organisation</i> window below will appear. ",
                ...
                "The selected organizations are now in the list <i>Send to organisations...</i>.</p>",
        ...
        write_paragraph_body("",
            ["<p><b>Only to user group...</b><br>",
                ...
                "but, for example, only to the chairperson and secretary, ",
                "you can click on <i>Only to user group...</i> ",
        ...
        write_paragraph_body("",
            ["<p><b>Create mailing list</b><br>",
             "Click on <i>Create mailing list</i> in the menu bar. The window below will appear.</p>",
            ...
            "Change the details and click <i>Save</i> or click <i>Clear Mailing List</i>.</p>",
            "<p><b>General use mailing list</b><br>",
            "If you want a mailing list to be used by the other users of your organization, ",
            "check the box <i>Available to all users of this organization</i>. ",
