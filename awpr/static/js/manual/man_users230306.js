...
/////////  NEDERLANDS //////////////////////////////
    nl: [
        ...
        write_paragraph_body("", [
            ...
            "<ul class='manual_bullet'><li><b>Toegestane scholen</b>. Alleen van toepassing voor accounts van gecommitteerden, die door het Ministerie van Onderwijs worden aangemaakt.</li>",
            "<li><b>Toegestane afdelingen</b>. De gebruiker kan alleen de opgegeven afdelingen (Vsbo, Havo, Vwo) inzien.</li>",
            "<li><b>Toegestane leerwegen</b>. De gebruiker kan alleen de opgegeven leerwegen inzien.</li>",
            "<li><b>Toegestane vakken</b>. De gebruiker kan alleen de opgegeven vakken inzien. Voor elke toegestane school, afdeling of leerweg kunnen de toegestane vakken apart worden ingesteld. </li>",
            "<li><b>Toegestane clusters</b>. De gebruiker kan alleen de opgegeven clusters wijzigen.</li></ul></p>",

             "<p>Wanneer <b>toegestane scholen, afdelingen, leerwegen en /of vakken</b> worden ingesteld, kan de gebruiker alleen de gegevens zien van de opgegeven scholen, afdelingen, leerwegen en /of vakken.<br>",
             ...
             "Deze gebruiker kan de gegevens van alle kandidaten inzien, maar kan alleen de cijfers wijzigen en goedkeuren van het vak Wiskunde van de kandidaten in de cluster 'wk -2'.</li>",
