...
/////////  NEDERLANDS //////////////////////////////
    nl: [
        ...
        write_paragraph_header("id_block_grades", "Controle door de Inspectie"),
        write_paragraph_body("",
            ["<p>Na het indienen van scores en cijfers worden ze zichtbaar voor het ETE en de Inspectie en kan de Inspectie ze controleren. ",
                "Wanneer de Inspectie vragen of opmerkingen heeft kan ze een <b>notitie</b> toevoegen. ",
                "Er verschijnt dan een icoontje in de kolom opmerkingen. Klik op het icoontje om de notitie te lezen.</p>"
            ]),

        write_paragraph_body("",
            ["<p class='pb-0'>De betekenis van de icoontjes is als volgt:</p>",
                "<div class='mfc mb-2'>",
                    "<div class='mfl'><p></p></div>",
                    "<div class='mfr mb-0'>",
                        "<div class='mfc'>",
                            "<div class='mfl'><p class='note_0_1'></p></div>",
                            "<div class='mfr'>Interne memo. Een interne memo is alleen zichtbaar voor gebruikers van de eigen school.</div>",
                        "</div>",
                        "<div class='mfc'>",
                            "<div class='mfl'><p class='note_1_1'></p></div>",
                            "<div class='mfr'>Externe memo. Externe memo's zijn ook zichtbaar voor het ETE en de Inspectie.</div>",
                        "</div>",
                        "<div class='mfc'>",
                            "<div class='mfl'><p class='note_1_3'></p></div>",
                            "<div class='mfr'>Aandachtspunt. De Inspectie heeft vragen of opmerkingen bij het cijfer.</div>",
                        "</div>",
                        "<div class='mfc'>",
                            "<div class='mfl'><p class='note_1_4'></p></div>",
                            "<div class='mfr'>Afkeuring. De Inspectie heeft het cijfer afgekeurd.</div>",
                        "</div>",

                        "<div class='mfc'>",
                            "<div class='mfl'><p class='note_1_6'></p></div>",
                            "<div class='mfr'>Akkoord. De inspectie is akkoord met het antwoord en eventuele correctie van het cijfer ",
                            "en heeft de eventuele ontgrendeling opgeheven.</div>",
                        "</div>",
                    "</div>",
                "</div>"
            ]),
        write_paragraph_body("",
            [ "<p>De Inspectie heeft de mogelijkheid om een score of cijfer te <b>ontgrendelen</b>. In dat geval kleurt de ruit rood. ",
                "Als een score of cijfer is ontgrendeld is de goedkeuring verwijderd en kun je het cijfer corrigeren. ",
                "Je moet het dan opnieuw goedkeuren en indienen. ",
                "Zolang een cijfer is ontgrendeld is het niet mogelijk om de definitieve cijferlijst of het diploma te printen.</p>",
                 "<p>Je kunt <b>reageren op een notitie van de Inspectie</b> door op het icoontje van de notitie te klikken ",
                "en een nieuwe notitie toe te voegen. ",
                "Let erop dat je <i>Externe memo</i> selecteert, omdat alleen externe memo's door de Inspectie kunnen worden gelezen.</p>",
                "<p>Indien nodig kun je een <b>bijlage</b> meesturen met de notitie. Klik op de knop <i>Bijlage</i> om de bijlage te uploaden.<br>",
                "Als je een bijlage uploadt is dat niet meteen zichtbaar in het scherm. Pas nadat je de notitie hebt verstuurd wordt de bijlage zichtbaar. ",
                "Dit zal nog gecorrigeerd worden.</p>",
            ]),
...
write_paragraph_header("id_block_grades", "Check by the Inspectorate"),
         write_paragraph_body("",
             ["<p>After submitting scores and grades, they become visible to the Division of Examinations and the Inspectorate. ",
                 "If the Inspectorate has questions or comments, it can add a <b>note</b>. ",
                 "An icon will appear in the comments column. Click on the icon to read the note.</p>"
             ]),

         write_paragraph_body("",
             ["<p class='pb-0'>The meaning of the icons is as follows:</p>",
                 "<div class='mfc mb-2'>",
                     "<div class='mfl'><p></p></div>",
                     "<div class='mfr mb-0'>",
                         "<div class='mfc'>",
                             "<div class='mfl'><p class='note_0_1'></p></div>",
                             "<div class='mfr'>Internal memo. An internal memo is only visible to users of its own school.</div>",
                         "</div>",
                         "<div class='mfc'>",
                             "<div class='mfl'><p class='note_1_1'></p></div>",
                             "<div class='mfr'>External memo. External memos are also visible to the Division of Examinations and the Inspectorate.</div>",
                         "</div>",
                         "<div class='mfc'>",
                             "<div class='mfl'><p class='note_1_3'></p></div>",
                             "<div class='mfr'>Point of attention. The Inspectorate has questions or comments about the grade.</div>",
                         "</div>",
                         "<div class='mfc'>",
                             "<div class='mfl'><p class='note_1_4'></p></div>",
                             "<div class='mfr'>Disapproval. The Inspectorate has rejected the grade.</div>",
                         "</div>",

                         "<div class='mfc'>",
                             "<div class='mfl'><p class='note_1_6'></p></div>",
                             "<div class='mfr'>Approved. The inspector has approved the answer and possible correction of the grade ",
                             "and has removed the unlocking if any.</div>",
                         "</div>",
                     "</div>",
                 "</div>"
             ]),
         write_paragraph_body("",
             [ "<p>The Inspectorate has the option to <b>unlock</b> a score or grade. In that case the diamond turns red. ",
                 "When a score or grade is unlocked, the approval is removed and you can correct the grade. ",
                 "You must then re-approve and submit it. ",
                 "As long as a grade is unlocked, it is not possible to print the final grade list or diploma.</p>",
                  "<p>You can <b>respond to a note from the Inspectorate</b> by clicking the icon of the note and add a new note. ",
                 "Make sure you select <i>External memo</i> as only external memos can be read by the Inspectorate.</p>",
                 "<p>If necessary, you can send an <b>attachment</b> with the note. Click the <i>Attachment</i> button to upload the attachment.<br>",
                 "If you upload an attachment, it is not immediately visible on the screen. The attachment only becomes visible after you have sent the note. ",
                 "This will be corrected.</p>",
             ]),
