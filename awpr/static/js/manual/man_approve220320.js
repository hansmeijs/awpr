    ...
    en:  [
        ...
        "<div class='mfc'>",
            ...
            "<div class='mfr'>",
                "<p>When submitting the Ex forms, the signature on paper has been replaced by a digital signature.</p>",
                 ...
                 "<ul class='manual_bullet mb-0'><li>The first step is the <b>approval</b> of the subjects, scores or grades by the chairperson, secretary, examinator and possibly the commissioner.</li>",
        ...
        "<div class='mfc'>",
            ...
            "<div class='mfr'>",
                ...
                "<li>A chairperson or secretary can also sign as examinator.</li>",
                "<li>A commissioner may not also sign as chairperson, secretary or examinator.</li>",
