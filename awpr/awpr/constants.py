...
GL_STATUS_00_NONE = 0
GL_STATUS_01_APPROVED = 1
GL_STATUS_02_REJECTED = 2
...
KEY_SEL_SUBJBASE_PK = 'sel_subjbase_pk' #PR2023-05-18 not in use yet, muste replace sel_subject_pk
...
KEY_SEL_CLASSES = 'sel_classes' # PR2023-06-03 use in mod report resultmeeting in result page
KEY_SORTBY_CLASS = 'sortby_class' # PR2023-06-03 use in mod report resultmeeting in result page
